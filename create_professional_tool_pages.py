...
def create_professional_tool_pages():
    ...
    try:
        ...
        for tool_name, tool_data in tools.items():
            # Template content without f-string issues
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 mb-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div class="text-center p-4 bg-""" + tool_data['color'] + """-50 rounded-xl">
                        <div class="text-sm font-medium text-""" + tool_data['color'] + """-800">Secure Processing</div>
                    </div>
                    <div class="text-center p-4 bg-""" + tool_data['color'] + """-50 rounded-xl">
                        <div class="text-sm font-medium text-""" + tool_data['color'] + """-800">Fast Results</div>
                    </div>
                    <div class="text-center p-4 bg-""" + tool_data['color'] + """-50 rounded-xl">
                        <div class="text-sm font-medium text-""" + tool_data['color'] + """-800">High Quality</div>
                    </div>
                    <div class="text-center p-4 bg-""" + tool_data['color'] + """-50 rounded-xl">
                        <div class="text-sm font-medium text-""" + tool_data['color'] + """-800">Free to Use</div>
                    </div>
                </div>
            </div>
...
if __name__ == "__main__":
    success = create_professional_tool_pages()
    if success:
