class IconManager {
    ...
    adaptToTheme(isDark) {
        const icons = document.querySelectorAll('svg[id*="toolora"]');
        icons.forEach(icon => {
            const gradientId = isDark ? 'darkMode' : 'primaryBrand';
            const fills = icon.querySelectorAll('[fill*="url(#"]');
            fills.forEach(fill => {
...
class IconManager {
    constructor() {
        ...
        this.headerLogo = '/static/images/toolora-professional-logo.svg';
        this.favicon = '/static/favicon.svg';
        this.socialLogo = '/static/images/toolora-professional-logo.svg';
        this.compactIcon = '/static/images/toolora-icon-only.svg';
        this.init();
    }
